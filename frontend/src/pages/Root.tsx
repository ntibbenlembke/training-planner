...
export default function Root() {
    ...
    // If already authenticated, redirect to calendar page
    if (isAuthenticated) {
        navigate('/calendar');
    }
    ...
    async function handleSignUpWithUsernameAndPassword() {
        setIsLoading(true);
        setError('');
    ...
    return (
        <div className="flex flex-col min-h-screen bg-paper">
            ...
            {location.pathname === '/' && (<div className="flex flex-col items-center justify-center min-h-screen ">
                ...
                <div className="mb-4">
                    ...
                    <button 
                        onClick={handleSignUpWithUsernameAndPassword}
                        className="w-full py-3 px-2 bg-blue text-white border-blue hover:bg-blue-dark hover:border-blue-dark mt-4" >
                        Sign Up With Email
                    </button>
                </div>
